...
\begin{theorem}[\cite{sofsem2014}, Theorem 6]\label{theorem:sofsem6}
    ...
    $k \in \N$, that uses at most $$\ceil*{\ceil*{4L/c^2}\log3}$$ bits of
    advice.
\end{theorem}
...
\begin{theorem}[\cite{sofsem2014}, Theorem 7]\label{theorem:sofsem7}
    ...
    at most $$\ceil*{2(L-1)/c}$$ bits of advice.
\end{theorem}
...
\begin{proof}
    ...
    $U_L$ of instances consisting of two phases. The first phase of each
    ...
    $A$ to make $e$ mistakes in phase $1$, its competitive ratio is
