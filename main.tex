...
% TikZ setup for DPA figures
\tikzstyle{vertex} = [circle, thick, draw, inner sep=2]
\tikzstyle{query vertex} = [vertex, fill=white]
\tikzstyle{path vertex} = [vertex, fill=black]
\tikzstyle{edge} = [thick]
...
\todo{Unify the capitalization of chapters.}
\label{chapter:first}
